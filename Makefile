...
installv1-local: ## Install operator using local controller instead of operator deployment
	@echo ....... Installing .......
	@echo ....... Applying CRD and Operator .......
	- kubectl apply -f deploy/crds/operator.ibm.com_auditloggings_crd.yaml
	- kubectl apply -f deploy/crds/operator.ibm.com_commonauditloggings_crd.yaml
	@echo ....... Creating AuditLogging CR .......
	- kubectl apply -f deploy/crds/operator.ibm.com_v1_commonauditlogging_cr.yaml -n ${NAMESPACE}
	@echo ....... Running Operator .......
	- operator-sdk run --local
...
uninstallv1-local: ## Uninstall all that all performed in the $ make install-local
	@echo ....... Uninstalling .......
	@echo ....... Deleting CRs .......
	- kubectl get auditpolicy -n ${NAMESPACE} | grep audit | awk '{print $$1}' | xargs kubectl delete auditpolicy -n ${NAMESPACE}
	- kubectl delete -f deploy/crds/operator.ibm.com_v1_commonauditlogging_cr.yaml -n ${NAMESPACE}
	@echo ....... Deleting CRD.......
	- kubectl delete -f deploy/crds/operator.ibm.com_auditloggings_crd.yaml
	- kubectl delete -f deploy/crds/operator.ibm.com_commonauditloggings_crd.yaml
