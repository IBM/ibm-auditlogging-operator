...
install: ## Install all resources (CR/CRD's, RBCA and Operator)
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_v1_auditlogging_cr.yaml -n ${NAMESPACE}

uninstall: ## Uninstall all that all performed in the $ make install
	@echo ....... Uninstalling .......
	@echo ....... Deleting CRs .......
	- kubectl get auditpolicy -n ${NAMESPACE} | grep audit | awk '{print $$1}' | xargs kubectl delete auditpolicy -n ${NAMESPACE}
	- kubectl delete -f deploy/crds/operator.ibm.com_v1_auditlogging_cr.yaml -n ${NAMESPACE}
