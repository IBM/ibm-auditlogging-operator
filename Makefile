...
install: ## Install all resources (CR/CRD's, RBCA and Operator)
	...
	@echo ....... Wait for Audit Policy CRD creation .......
	- sleep 30
	@echo ....... Creating AuditPolicy CR .......
	- kubectl apply -f deploy/crds/example_auditpolicy_cr.yaml -n ${NAMESPACE}

uninstall: ## Uninstall all that all performed in the $ make install
	@echo ....... Uninstalling .......
	@echo ....... Deleting CRs .......
	- kubectl delete -f deploy/crds/example_auditpolicy_cr.yaml -n ${NAMESPACE}
