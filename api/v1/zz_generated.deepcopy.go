...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonAuditSpecLogDNA) DeepCopyInto(out *CommonAuditSpecLogDNA) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonAuditSpecLogDNA.
func (in *CommonAuditSpecLogDNA) DeepCopy() *CommonAuditSpecLogDNA {
	if in == nil {
		return nil
	}
	out := new(CommonAuditSpecLogDNA)
	in.DeepCopyInto(out)
	return out
}
