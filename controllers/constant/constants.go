...
const TestImageRegistry = "quay.io/hbradfield/"
const DefaultFluentdImageName = "fluentd"
const DefaultFluentdImageTag = "v1.6.2-bedrock-1"
const FluentdEnvVar = "FLUENTD_TAG_OR_SHA"
const OperatorNamespaceKey = "POD_NAMESPACE"
const DefaultJobImageName = "audit-garbage-collector"
const DefaultJobImageTag = "0.0.1"
const JobEnvVar = "JOB_TAG_OR_SHA"
const PolicyControllerEnvVar = "POLICY_CTRL_TAG_OR_SHA"
const DefaultPCImageTag = "3.5.2"
const AuditTypeLabel string = "operator.ibm.com/managedBy-audit"
