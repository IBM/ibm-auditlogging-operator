...
func (r *ReconcileCommonAuditLogging) reconcileServiceAccount(cr *operatorv1.CommonAuditLogging) (reconcile.Result, error) {
...
func (r *ReconcileCommonAuditLogging) reconcileRole(instance *operatorv1.CommonAuditLogging) (reconcile.Result, error) {
...
func (r *ReconcileCommonAuditLogging) reconcileRoleBinding(instance *operatorv1.CommonAuditLogging) (reconcile.Result, error) {
