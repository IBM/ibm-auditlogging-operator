...
The ibm-auditlogging-operator and Policy Controller Operand support running under the OpenShift Container Platform default restricted security context constraints.  The AuditLogging (Fluentd) Operand runs under privileged security constraints.
