...
- 3.6.1
  ...
  Tech Preview - Included in version 3.6.0 and 3.6.1, support for sending audit log records
  over HTTP.
...
- AuditLogging Operator must run in the `ibm-common-services` namespace
...
Issue these commands to collect information about the audit logging deployment.
...
Issue these commands to collect logs:
